...
//
//   .glassdocs/chat/history.json   on branch `glassdocs-chat`
//
...
// `git fetch` the branch (or `gh api ...?ref=glassdocs-chat`) and parse
...
export const CHAT_BRANCH = "glassdocs-chat";
export const CHAT_DIR = ".glassdocs/chat";
export const CHAT_FILE = `${CHAT_DIR}/history.json`;

/** On-disk shape of `.glassdocs/chat/history.json`. */
...
/**
 * Commit `messages` to `.glassdocs/chat/history.json` on the dedicated
