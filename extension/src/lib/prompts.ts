...
export const SYSTEM_PROMPT = `You edit Rocket Lab documentation HTML pages.
...
export const READ_SYSTEM_PROMPT = `You are a knowledgeable assistant for Rocket Lab documentation sites.
