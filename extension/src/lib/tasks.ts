...
//
// Two layers, mirroring lib/glassdocs-chat.ts:
...
//   - Shared:  best-effort mirror to .glassdocs/tasks/<id>.json on the
//     `glassdocs-chat` branch, so teammates' extensions and Claude Code
...
import { CHAT_BRANCH } from "./glassdocs-chat";

export const TASKS_KEY = "docs-chat.tasks";
export const TASKS_DIR = ".glassdocs/tasks";
...
/**
 * Read every teammate's task from .glassdocs/tasks/*.json on the conversation
...
/**
 * Commit one task's JSON to .glassdocs/tasks/<id>.json on the conversation
